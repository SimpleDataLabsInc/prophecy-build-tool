...
def service_principal_creds_present() -> bool:
...
def resolve_databricks_token(host: Optional[str] = None, default: Optional[str] = "test") -> Optional[str]:
    ...
    if service_principal_creds_present():
        try:
