    ...
    return DatabricksSubmitRunOperator(  # noqa
        ...
        json = {
          ...
          "libraries": [{"maven" : {"coordinates" : "io.prophecy:prophecy-libs_2.12:3.5.0-9.2.0"}},                          {
                           "jar": "/Volumes/pbt_testing/default/prophecy//prophecy/artifacts/saas/app/__PROJECT_ID_PLACEHOLDER__/__PROJECT_RELEASE_VERSION_PLACEHOLDER__/pipeline/silver_zip_codes_2.12.jar"
                         }]
        },
